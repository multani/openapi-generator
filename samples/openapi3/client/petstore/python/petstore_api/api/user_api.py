...
class UserApi:
    ...
    @validate_arguments
    def create_user(self, user : Annotated[User, Field(..., description="Created user object")], **kwargs) -> None:
        """Create user
    ...
    @validate_arguments
    def create_users_with_array_input(self, user : Annotated[conlist(User), Field(..., description="List of user object")], **kwargs) -> None:
    ...
    @validate_arguments
    def create_users_with_list_input(self, user : Annotated[conlist(User), Field(..., description="List of user object")], **kwargs) -> None:
        """Creates list of users with given input array
    ...
    @validate_arguments
    def delete_user(self, username : Annotated[StrictStr, Field(..., description="The name that needs to be deleted")], **kwargs) -> None:
        """Delete user
    ...
    @validate_arguments
    def get_user_by_name(self, username : Annotated[StrictStr, Field(..., description="The name that needs to be fetched. Use user1 for testing.")], **kwargs) -> User:
    ...
    @validate_arguments
    def login_user(self, username : Annotated[StrictStr, Field(..., description="The user name for login")], password : Annotated[StrictStr, Field(..., description="The password for login in clear text")], **kwargs) -> str:
    ...
    @validate_arguments
    def logout_user(self, **kwargs) -> None:
    ...
    @validate_arguments
    def update_user(self, username : Annotated[StrictStr, Field(..., description="name that need to be deleted")], user : Annotated[User, Field(..., description="Updated user object")], **kwargs) -> None:
        """Updated user
