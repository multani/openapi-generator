...
class StoreApi:
    ...
    @validate_arguments
    async def delete_order(self, order_id : Annotated[StrictStr, Field(..., description="ID of the order that needs to be deleted")], **kwargs) -> None:
    ...
    @validate_arguments
    async def get_inventory(self, **kwargs) -> Dict[str, int]:
    ...
    @validate_arguments
    async def get_order_by_id(self, order_id : Annotated[conint(strict=True, le=5, ge=1), Field(..., description="ID of pet that needs to be fetched")], **kwargs) -> Order:
    ...
    @validate_arguments
    async def place_order(self, order : Annotated[Order, Field(..., description="order placed for purchasing the pet")], **kwargs) -> Order:
